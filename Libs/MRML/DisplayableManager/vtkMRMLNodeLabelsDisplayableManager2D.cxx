...
public:
  ...
  bool CheckCollision(const double pos1[2], const double size1[2], const double pos2[2], const double size2[2]);
...
//---------------------------------------------------------------------------
vtkMRMLNodeLabelsDisplayableManager2D::vtkInternal::vtkInternal(vtkMRMLNodeLabelsDisplayableManager2D* external)
{
...
//---------------------------------------------------------------------------
void vtkMRMLNodeLabelsDisplayableManager2D::vtkInternal::AddLabel(vtkMRMLLabelDisplayNode* displayNode)
{
...
//---------------------------------------------------------------------------
void vtkMRMLNodeLabelsDisplayableManager2D::vtkInternal::UpdateLabel(vtkMRMLLabelDisplayNode* displayNode)
{
  if (!displayNode || !displayNode->GetID())
  {
    return;
...
//---------------------------------------------------------------------------
void vtkMRMLNodeLabelsDisplayableManager2D::vtkInternal::RemoveLabel(vtkMRMLLabelDisplayNode* displayNode)
{
  if (!displayNode || !displayNode->GetID())
  {
    return;
...
//---------------------------------------------------------------------------
void vtkMRMLNodeLabelsDisplayableManager2D::vtkInternal::WorldToDisplay(const double worldPos[3], double displayPos[2])
{
  vtkMRMLSliceNode* sliceNode = this->External->GetMRMLSliceNode();
  if (!sliceNode || !this->GetRenderer())
  {
    displayPos[0] = 0;
    displayPos[1] = 0;
    return;
...
//---------------------------------------------------------------------------
void vtkMRMLNodeLabelsDisplayableManager2D::vtkInternal::DisplayToWorld(const double displayPos[2], double worldPos[3])
{
  vtkMRMLSliceNode* sliceNode = this->External->GetMRMLSliceNode();
  if (!sliceNode || !this->GetRenderer())
  {
  ...
  double* world = coordinate->GetComputedWorldValue(this->GetRenderer());
...
void vtkMRMLNodeLabelsDisplayableManager2D::vtkInternal::UpdateLabelPositions()
{
  ...
  // Collision avoidance pass (same strategy as 3D)
  const int minGap = 3; // slightly tighter in 2D slice views
...
//---------------------------------------------------------------------------
bool vtkMRMLNodeLabelsDisplayableManager2D::vtkInternal::CheckCollision(const double pos1[2], const double size1[2], const double pos2[2], const double size2[2])
{
...
//----------------------------------------------------------------------------
void vtkMRMLNodeLabelsDisplayableManager2D::ProcessMRMLNodesEvents(vtkObject* caller, unsigned long event, void* callData)
{
