...
//---------------------------------------------------------------------------
void vtkMRMLModelDisplayableManager::GetActorsByDisplayNode(
  vtkPropCollection* actors, vtkMRMLDisplayNode* displayNode, int vtkNotUsed(component), int vtkNotUsed(index))
{
  if (!displayNode)
  {
    return;
  ...
  const char* id = displayNode->GetID();
  if (!id)
  {
    return;
  }
