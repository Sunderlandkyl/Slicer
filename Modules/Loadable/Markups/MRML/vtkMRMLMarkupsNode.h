...
public:
  ...
  virtual vtkMatrix4x4* GetInteractionHandleModelToWorld();
...
protected:
  ...
  virtual void UpdateInteractionHandleModelToWorld();
  ...
  vtkSmartPointer<vtkMatrix4x4> InteractionHandleModelToWorld;
