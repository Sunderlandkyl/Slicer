...
public:
  ...
  /// Get the direction axis for the handle specified by the index
  virtual void GetInteractionAxisWorld(int index, double axis[3]);
  /// Get the origin of the interaction handle widget
  virtual void GetInteractionOriginWorld(double origin[3]);
  ...
  /// Get the direction vector to the interaction handle from the interaction origin
  /// Type is specified using vtkMRMLMarkupsDisplayNode::ComponentType
  virtual void GetInteractionHandleVector(int type, int index, double axis[3]);
  /// Get the direction vector to the interaction handle from the interaction origin in world coordinates
