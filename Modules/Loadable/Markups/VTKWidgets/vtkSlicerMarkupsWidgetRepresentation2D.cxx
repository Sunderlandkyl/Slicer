  ...
  int& foundComponentType, int& foundComponentIndex, double& closestDistance2)
{
  ...
  if (!handlePicked)
    ...
    for (vtkSlicerMarkupsWidgetRepresentation::MarkupsInteractionPipeline::HandleInfo handleInfo : handleInfoList)
      ...
      this->InteractionPipeline->GetInteractionOriginWorld(originWorldPos);
  ...
  : MarkupsInteractionPipeline(representation)
{
  ...
  this->WorldToSliceTransformFilter->SetInputConnection(this->ModelToWorldTransformFilter->GetOutputPort());
