...
public:
  ...
  /// Get the component type of an owned subject hierarchy item.
  /// The default implementation returns -1.
  virtual int componentType(vtkIdType itemID);
  /// Get the component index of an owned subject hierarchy item.
  /// The default implementation returns -1.
  virtual int componentIndex(vtkIdType itemID);
