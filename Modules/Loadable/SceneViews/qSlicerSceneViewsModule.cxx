...
void qSlicerSceneViewsModulePrivate::addToolBar()
{
  ...
  QObject::connect(qSlicerApplication::application(), SIGNAL(mrmlSceneChanged(vtkMRMLScene*)), this->CaptureToolBar, SLOT(updateSceneViewNavigationFromScene()));
...
{
  Q_D(qSlicerSceneViewsModule);
  vtkSlicerSceneViewsModuleLogic* logic = vtkSlicerSceneViewsModuleLogic::New();
  d->CaptureToolBar->setSceneViewsLogic(logic);
  return logic;
}
